...
tubax.core.xml__GT_clj.cljs$core$IFn$_invoke$arity$2 = (function (source,p__29280){
...
var strict = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29281__$1,cljs.core.cst$kw$strict,true);
var trim = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29281__$1,cljs.core.cst$kw$trim,true);
var normalize = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29281__$1,cljs.core.cst$kw$normalize,false);
var lowercase = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29281__$1,cljs.core.cst$kw$lowercase,true);
var xmlns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29281__$1,cljs.core.cst$kw$xmlns);
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29281__$1,cljs.core.cst$kw$position,true);
var strict_entities = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29281__$1,cljs.core.cst$kw$strict_DASH_entities,false);
...
parser.onopentag = ((function (parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__29273_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_node_document,p1__29273_SHARP_));
});})(parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onclosetag = ((function (parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__29274_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.close_node_document,p1__29274_SHARP_));
});})(parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.ontext = ((function (parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__29275_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__29275_SHARP_));
});})(parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.oncdata = ((function (parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__29276_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__29276_SHARP_));
});})(parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onend = ((function (parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (){
...
parser.onerror = ((function (parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__29277_SHARP_){
return cljs.core.reset_BANG_(result,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$error,cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29277_SHARP_)], null));
});})(parser,document,result,map__29281,map__29281__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;
...
var or__4131__auto__ = cljs.core.cst$kw$success.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(result));
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$error.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(result))),cljs.core.PersistentArrayMap.EMPTY);
}
});
