...
var G__28795_28797 = tag;
var G__28796_28798 = goog.dom.createTextNode("");
goog.dom.appendChild(G__28795_28797,G__28796_28798);
...
if(cljs.core.truth_((function (){var fexpr__28799 = cljs.core.deref(self__.cache);
return (fexpr__28799.cljs$core$IFn$_invoke$arity$1 ? fexpr__28799.cljs$core$IFn$_invoke$arity$1(cls_name) : fexpr__28799.call(null,cls_name));
})())){
return null;
} else {
...
var rules_count = (function (){var G__28800 = goog.object.get(self__.sheet,"cssRules");
var G__28801 = "length";
return goog.object.get(G__28800,G__28801);
})();
if(cljss.utils.dev_QMARK_){
var G__28802 = self__.tag;
var G__28803 = goog.dom.createTextNode(rule__$1);
return goog.dom.appendChild(G__28802,G__28803);
} else {
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$tag,cljs.core.cst$sym$sheet,cljs.core.cst$sym$cache], null);
});
