...
var vec__27156 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$username,cljs.core.cst$kw$password], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27156,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27156,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__27159){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27160__$1,cljs.core.cst$kw$scheme);
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27160__$1,cljs.core.cst$kw$server_DASH_name);
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27160__$1,cljs.core.cst$kw$server_DASH_port);
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27160__$1,cljs.core.cst$kw$uri);
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27160__$1,cljs.core.cst$kw$query_DASH_string);
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__27163 = (new goog.Uri());
G__27163.setScheme(cljs.core.name((function (){var or__4131__auto__ = scheme;
...
G__27163.setDomain(server_name);

G__27163.setPort(server_port);

G__27163.setPath(uri);

G__27163.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__27165_SHARP_,p2__27164_SHARP_){
var vec__27166 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__27164_SHARP_,/:\s+/);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__27165_SHARP_,clojure.string.lower_case(k),v);
}
