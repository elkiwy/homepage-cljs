...
return (new CustomEvent(event_name,(function (){var obj38052 = ({"detail":data});
return obj38052;
})()));
} else {
...
var f = (function (){var pred__38059 = cljs.core._EQ_;
var expr__38060 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38059.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38060))){
return ((function (pred__38059,expr__38060){
return (function (p1__38053_SHARP_){
return console.warn(p1__38053_SHARP_);
});
;})(pred__38059,expr__38060))
} else {
if(cljs.core.truth_(pred__38059.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38060))){
return ((function (pred__38059,expr__38060){
return (function (p1__38054_SHARP_){
return console.debug(p1__38054_SHARP_);
});
;})(pred__38059,expr__38060))
} else {
if(cljs.core.truth_(pred__38059.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38060))){
return ((function (pred__38059,expr__38060){
return (function (p1__38055_SHARP_){
return console.error(p1__38055_SHARP_);
});
;})(pred__38059,expr__38060))
} else {
return ((function (pred__38059,expr__38060){
return (function (p1__38056_SHARP_){
return console.log(p1__38056_SHARP_);
});
;})(pred__38059,expr__38060))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__38063){
...
var opts = map__38064__$1;
var eval_fn = cljs.core.get.call(null,map__38064__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__38066_SHARP_);
});})(new_def))
);
...
return (function (p__38067){
var vec__38068 = p__38067;
var ky = cljs.core.nth.call(null,vec__38068,(0),null);
var v = cljs.core.nth.call(null,vec__38068,(1),null);
...
}catch (e38073){if((e38073 instanceof Error)){
var e = e38073;
return not_found;
} else {
throw e38073;
...
//# sourceMappingURL=utils.js.map?rel=1563617065542
