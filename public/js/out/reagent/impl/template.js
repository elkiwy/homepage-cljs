...
var G__26944 = o;
(G__26944[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__26945__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__26945 = function (var_args){
var args = null;
...
return G__26945__delegate.call(this,args);};
G__26945.cljs$lang$maxFixedArity = 0;
G__26945.cljs$lang$applyTo = (function (arglist__26947){
var args = cljs.core.seq(arglist__26947);
return G__26945__delegate(args);
});
...
var G__26948 = o;
(G__26948[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__26950__i < G__26950__a.length) {G__26950__a[G__26950__i] = arguments[G__26950__i + 0]; ++G__26950__i;}
  args = new cljs.core.IndexedSeq(G__26950__a,0,null);
} 
...
var G__26953 = props;
var G__26953__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__26953,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26953);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__26953__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26954){
var map__26955 = p__26954;
var map__26955__$1 = (((((!((map__26955 == null))))?(((((map__26955.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26955.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26955):map__26955);
var props = map__26955__$1;
var class$ = cljs.core.get.call(null,map__26955__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__26955,map__26955__$1,props,class$){
return (function (c){
...
});})(map__26955,map__26955__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26957){
...
var on_write = cljs.core.get.call(null,map__26958__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__26958,map__26958__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__26958,map__26958__$1,on_write))
);
} else {
...
var G__26961 = jsprops;
(G__26961["defaultValue"] = value);

(G__26961["onChange"] = ((function (G__26961,v,value,on_change){
return (function (p1__26960_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26960_SHARP_);
});})(G__26961,v,value,on_change))
);
...
var vec__26964 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26964,(0),null);
var id = cljs.core.nth.call(null,vec__26964,(1),null);
var class$ = cljs.core.nth.call(null,vec__26964,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___26968 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___26968 == null)){
} else {
var key_26969 = temp__5724__auto___26968;
(jsprops["key"] = key_26969);
}
...
var temp__5724__auto___26970 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___26970 == null)){
} else {
var key_26971 = temp__5724__auto___26970;
reagent.impl.template.oset.call(null,jsprops,"key",key_26971);
}
...
var G__26972 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__26972["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26976){
var G__26977 = cljs.core.first.call(null,seq26976);
var seq26976__$1 = cljs.core.next.call(null,seq26976);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26977,seq26976__$1);
});
...
break;
default:
var G__26983 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__26983;
continue;
...
var n__4607__auto___26985 = a.length;
var i_26986 = (0);
while(true){
if((i_26986 < n__4607__auto___26985)){
(a[i_26986] = reagent.impl.template.as_element.call(null,(a[i_26986])));

var G__26987 = (i_26986 + (1));
i_26986 = G__26987;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___26988 = a.length;
var i_26989 = (0);
while(true){
if((i_26989 < n__4607__auto___26988)){
var val_26990 = (a[i_26989]);
if(((cljs.core.vector_QMARK_.call(null,val_26990)) && ((reagent.impl.template.key_from_vec.call(null,val_26990) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26989] = reagent.impl.template.as_element.call(null,val_26990));

var G__26991 = (i_26989 + (1));
i_26989 = G__26991;
continue;
} else {
}
...
var ctx = ({});
var vec__26992 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26992,(0),null);
var derefed = cljs.core.nth.call(null,vec__26992,(1),null);
...
var G__26995 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26995) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__26995){
...
//# sourceMappingURL=template.js.map?rel=1563617058011
