...
var o35669 = temp__5718__auto__;
var temp__5718__auto____$1 = (o35669["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o35670 = temp__5718__auto____$1;
return (o35670["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34779__auto__ = f;
return (o__34779__auto__["toString"]).call(o__34779__auto__);
} else {
return "";
}
}catch (e35671){var _ = e35671;
return "";
}});
...
try{var o__34779__auto___35673 = t;
(o__34779__auto___35673["cljs$lang$ctorPrWriter"]).call(o__34779__auto___35673,t,writer);
}catch (e35672){var __35674 = e35672;
}
...
var char_code = (function (){var o__34779__auto__ = (new String(char$));
return (o__34779__auto__["charCodeAt"]).call(o__34779__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34779__auto__ = String;
return (o__34779__auto__["fromCharCode"]).call(o__34779__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__35675 = num_code;
switch (G__35675) {
case (1):
return (185);
...
var o__34779__auto__ = String;
return (o__34779__auto__["fromCharCode"]).call(o__34779__auto__,superscript_code);
});
/**
...
}catch (e35677){var _e__34786__auto__ = e35677;
return false;
}})())){
...
var vec__35678 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__35678,(0),null);
...
var or__4131__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
if(cljs.core.truth_(temp__5718__auto__)){
var o35681 = temp__5718__auto__;
var temp__5718__auto____$1 = (o35681["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o35682 = temp__5718__auto____$1;
return (o35682["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___35689 = arguments.length;
var i__4731__auto___35690 = (0);
while(true){
if((i__4731__auto___35690 < len__4730__auto___35689)){
args__4736__auto__.push((arguments[i__4731__auto___35690]));

var G__35691 = (i__4731__auto___35690 + (1));
i__4731__auto___35690 = G__35691;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__35685){
var vec__35686 = p__35685;
var ns_detector = cljs.core.nth.call(null,vec__35686,(0),null);
...
var G__35692 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__35693 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__35692;
remaining_tokens = G__35693;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq35683){
var G__35684 = cljs.core.first.call(null,seq35683);
var seq35683__$1 = cljs.core.next.call(null,seq35683);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35684,seq35683__$1);
});
...
var vec__35697 = cljs.core.split_with.call(null,(function (p1__35696_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35696_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__35697,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__35697,(1),null);
...
var vec__35703 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__35703,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__35703,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__35706 = cljs.core.rest.call(null,remaining_tokens);
var G__35707 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__35706;
name_tokens = G__35707;
continue;
} else {
...
var vec__35710 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__35710,(0),null);
var arity = cljs.core.nth.call(null,vec__35710,(1),null);
var vec__35713 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__35713,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__35713,(1),null);
var vec__35716 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__35716,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__35716,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__35716,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__35716,(3),null);
...
var vec__35722 = result;
var munged_ns = cljs.core.nth.call(null,vec__35722,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__35722,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__35722,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__35722,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__35722,(4),null);
var arity = cljs.core.nth.call(null,vec__35722,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__35726 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__35726,(0),null);
var args = cljs.core.nth.call(null,vec__35726,(1),null);
var vec__35729 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__35729,(0),null);
var name = cljs.core.nth.call(null,vec__35729,(1),null);
...
var G__35732 = (arity + (1));
var G__35733 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__35734){
var vec__35735 = p__35734;
var arity = cljs.core.nth.call(null,vec__35735,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__35735,(1),null);
...
return cljs.core.get.call(null,arities,p1__35738_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__35739_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__35742){
var vec__35743 = p__35742;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__35743,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq35740){
var G__35741 = cljs.core.first.call(null,seq35740);
var seq35740__$1 = cljs.core.next.call(null,seq35740);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35741,seq35740__$1);
});
...
var G__35749 = arg;
var G__35749__$1 = (((G__35749 instanceof cljs.core.Keyword))?G__35749.fqn:null);
switch (G__35749__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__35751__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__35751__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__35751__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__35751__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__35752 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__35752,(0),null);
var fn_name = cljs.core.nth.call(null,vec__35752,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__35752,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__35752,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__35752,(4),null);
var arity = cljs.core.nth.call(null,vec__35752,(5),null);
...
var o__34779__auto__ = f;
return (o__34779__auto__["getBasis"]).call(o__34779__auto__);
});
/**
...
}catch (e35756){var _e__34786__auto__ = e35756;
...
var G__35757 = (obj[cljs.core.first.call(null,path)]);
var G__35758 = cljs.core.rest.call(null,path);
obj = G__35757;
path = G__35758;
continue;
} else {
...
return (function (accum,p__35759){
var vec__35760 = p__35759;
var bit = cljs.core.nth.call(null,vec__35760,(0),null);
var protocol = cljs.core.nth.call(null,vec__35760,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__35763){
var vec__35764 = p__35763;
var ns = cljs.core.nth.call(null,vec__35764,(0),null);
var name = cljs.core.nth.call(null,vec__35764,(1),null);
var selector = cljs.core.nth.call(null,vec__35764,(2),null);
...
return (function (p__35768){
var vec__35769 = p__35768;
var munged_name = cljs.core.nth.call(null,vec__35769,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__35769,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__35769,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__35767_SHARP_){
return (obj[cljs.core.first.call(null,p1__35767_SHARP_)]);
});})(name,sorted_matches,vec__35769,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1563617062950
