...
var pred__37722 = cljs.core._EQ_;
var expr__37723 = (this$["nodeType"]);
if(cljs.core.truth_(pred__37722.call(null,hickory.core.Attribute,expr__37723))){
...
var pred__37725 = cljs.core._EQ_;
var expr__37726 = (this$["nodeType"]);
if(cljs.core.truth_(pred__37725.call(null,hickory.core.Attribute,expr__37726))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__37725.call(null,hickory.core.Comment,expr__37726))){
...
if(cljs.core.truth_(pred__37725.call(null,hickory.core.Document,expr__37726))){
...
if(cljs.core.truth_(pred__37725.call(null,hickory.core.DocumentType,expr__37726))){
...
if(cljs.core.truth_(pred__37725.call(null,hickory.core.Element,expr__37726))){
...
if(cljs.core.truth_(pred__37725.call(null,hickory.core.Text,expr__37726))){
return (this$["wholeText"]);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__37726)].join('')));
}
}
}
}
...
var temp__5720__auto__ = cljs.core.second.call(null,(function (){var or__4131__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var temp__5720__auto___37728 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__5720__auto___37728)){
var title_el_37729 = temp__5720__auto___37728;
if(cljs.core.empty_QMARK_.call(null,(title_el_37729["text"]))){
hickory.core.remove_el.call(null,title_el_37729);
} else {
}
} else {
}
...
var or__4131__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
//# sourceMappingURL=core.js.map?rel=1563617065001
