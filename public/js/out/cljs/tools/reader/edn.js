...
G__27379.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__27379;
})();
var G__27382 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__27381;
ch = G__27382;
continue;
}
...
var temp__5718__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__27383 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27383,ch);
...
var vec__27391 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27391,(0),null);
var start_column = cljs.core.nth.call(null,vec__27391,(1),null);
...
var G__27395 = (((!((mret === rdr))))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__27395;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__27394 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27394,ch);

return G__27394;
})(),true,null,opts);
var G__27396 = (((!((o === rdr))))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__27396;
continue;
}
}
...
var vec__27397 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27397,(0),null);
var start_column = cljs.core.nth.call(null,vec__27397,(1),null);
...
var sb = (function (){var G__27400 = (new goog.string.StringBuffer());
G__27400.append(initch);
...
var G__27402 = (function (){var G__27401 = sb;
G__27401.append(ch);

return G__27401;
})();
var G__27403 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27402;
ch = G__27403;
continue;
}
...
while(true){
var G__27406 = ch;
if(cljs.core._EQ_.call(null,null,G__27406)){
...
if(cljs.core._EQ_.call(null,"\\",G__27406)){
var G__27409 = (function (){var G__27407 = sb;
G__27407.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__27407;
})();
var G__27410 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27409;
ch = G__27410;
continue;
} else {
...
var G__27411 = (function (){var G__27408 = sb;
G__27408.append(ch);

return G__27408;
})();
var G__27412 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27411;
ch = G__27412;
continue;
...
var G__27416 = rdr;
cljs.tools.reader.edn.read.call(null,G__27416,true,null,true);
...
var temp__5718__auto__ = (function (){var G__27417 = token;
var G__27417__$1 = (((G__27417 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27417));
if((G__27417__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27417__$1);
}
})();
if(cljs.core.truth_(temp__5718__auto__)){
...
var G__27418 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27418)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27418)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27418)){
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27425,reader){
var map__27426 = p__27425;
var map__27426__$1 = (((((!((map__27426 == null))))?(((((map__27426.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27426.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27426):map__27426);
var opts = map__27426__$1;
var eof = cljs.core.get.call(null,map__27426__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
//# sourceMappingURL=edn.js.map?rel=1563617058808
