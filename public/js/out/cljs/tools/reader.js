...
var G__27251 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27251;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__27252 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27252,ch);
...
if(("\\" === ch__$1)){
var ch_27253__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_27253__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_27253__$2);
} else {
}

var G__27254 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__27254;
continue;
}
}
...
var vec__27262 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27262,(0),null);
var start_column = cljs.core.nth.call(null,vec__27262,(1),null);
...
var G__27265 = cljs.core.conj_BANG_.call(null,a,form);
a = G__27265;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__27266 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__27267 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__27267;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__27266;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27268 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27268,(0),null);
var start_column = cljs.core.nth.call(null,vec__27268,(1),null);
...
var vec__27271 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27271,(0),null);
var end_column = cljs.core.nth.call(null,vec__27271,(1),null);
...
var vec__27274 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27274,(0),null);
var start_column = cljs.core.nth.call(null,vec__27274,(1),null);
...
var vec__27277 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27277,(0),null);
var end_column = cljs.core.nth.call(null,vec__27277,(1),null);
...
var vec__27280 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27280,(0),null);
var start_column = cljs.core.nth.call(null,vec__27280,(1),null);
...
var vec__27283 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27283,(0),null);
var end_column = cljs.core.nth.call(null,vec__27283,(1),null);
...
var sb = (function (){var G__27286 = (new goog.string.StringBuffer());
G__27286.append(initch);
...
var G__27288 = (function (){var G__27287 = sb;
G__27287.append(ch);

return G__27287;
})();
var G__27289 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27288;
ch = G__27289;
continue;
}
...
switch (G__27292) {
case "\\":
var G__27296 = (function (){var G__27293 = sb;
G__27293.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27293;
})();
var G__27297 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27296;
ch = G__27297;
continue;
...
break;
default:
var G__27298 = (function (){var G__27294 = sb;
G__27294.append(ch);

return G__27294;
})();
var G__27299 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27298;
ch = G__27299;
continue;
...
var vec__27300 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27300,(0),null);
var end_column = cljs.core.nth.call(null,vec__27300,(1),null);
...
var vec__27303 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27303,(0),null);
var column = cljs.core.nth.call(null,vec__27303,(1),null);
...
var vec__27308 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27308,(0),null);
var column = cljs.core.nth.call(null,vec__27308,(1),null);
...
var vec__27313 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27313,(0),null);
var column = cljs.core.nth.call(null,vec__27313,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27318 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27318,(0),null);
var start_column = cljs.core.nth.call(null,vec__27318,(1),null);
...
var vec__27321 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27321,(0),null);
var end_column = cljs.core.nth.call(null,vec__27321,(1),null);
...
var G__27324 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27324,true,null,opts,pending_forms);
...
var G__27325 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27325)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27325)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27325)){
...
var _STAR_suppress_read_STAR__orig_val__27326 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27327 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27327;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__27326;
}});
...
var G__27328 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27328,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27328,rdr,first_line);
...
var G__27332 = matched;
var G__27333 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27332;
finished = G__27333;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__27334 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27335 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27335;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__27334;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__27336 = cljs.tools.reader.arg_env;
var arg_env_temp_val__27337 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__27337;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27338 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27338,"(");
...
var G__27339 = (i + (1));
var G__27340 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__27336;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27341 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27341);
...
var G__27342 = cljs.core.next.call(null,s__$1);
var G__27343 = ret;
s__$1 = G__27342;
r = G__27343;
continue;
...
var G__27344 = cljs.core.next.call(null,s);
var G__27345 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27344;
key_vals = G__27345;
continue;
} else {
...
var gensym_env_orig_val__27349 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__27350 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__27350;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__27349;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27351 = token;
var G__27351__$1 = (((G__27351 == null))?null:cljs.core.subs.call(null,G__27351,(1)));
var G__27351__$2 = (((G__27351__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27351__$1));
var G__27351__$3 = (((G__27351__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27351__$2));
var G__27351__$4 = (((G__27351__$3 == null))?null:cljs.core.symbol.call(null,G__27351__$3));
if((G__27351__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27351__$4);
}
})():(function (){var G__27352 = token;
var G__27352__$1 = (((G__27352 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27352));
if((G__27352__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27352__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e27359){if((e27359 instanceof Error)){
var e = e27359;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27363,reader){
...
var eof = cljs.core.get.call(null,map__27364__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___27372 = arguments.length;
var i__4731__auto___27373 = (0);
while(true){
if((i__4731__auto___27373 < len__4730__auto___27372)){
args__4736__auto__.push((arguments[i__4731__auto___27373]));

var G__27374 = (i__4731__auto___27373 + (1));
i__4731__auto___27373 = G__27374;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27370){
var G__27371 = cljs.core.first.call(null,seq27370);
var seq27370__$1 = cljs.core.next.call(null,seq27370);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27371,seq27370__$1);
});


//# sourceMappingURL=reader.js.map?rel=1563617058672
