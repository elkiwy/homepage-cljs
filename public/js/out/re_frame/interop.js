...
return [(function (){var pred__27584 = cljs.core.instance_QMARK_;
var expr__27585 = reactive_val;
if(cljs.core.truth_(pred__27584.call(null,reagent.ratom.RAtom,expr__27585))){
return "ra";
} else {
if(cljs.core.truth_(pred__27584.call(null,reagent.ratom.RCursor,expr__27585))){
return "rc";
} else {
if(cljs.core.truth_(pred__27584.call(null,reagent.ratom.Reaction,expr__27585))){
return "rx";
} else {
if(cljs.core.truth_(pred__27584.call(null,reagent.ratom.Track,expr__27585))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1563617058965
